...
## 5G USB Dongle
This repository refers to the OEM 5G USB Dongle SDX55 from online marketplaces but it can also applied to the known device called "VOS 5G Dongle". The software contains an operative system based on linux (Yocto) with BusyBox and snippets from CodeLinaro. For development modules Qualcomm SDK and OpenQuectel base code may be used.
